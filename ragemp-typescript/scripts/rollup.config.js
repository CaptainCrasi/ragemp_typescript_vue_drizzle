...
function copyFiles() {
	...
	prepareForCopy.push(
		...
		{
			from: jetpack.path('src/client/scripts'),
			to: jetpack.path(buildOutput, 'client_packages/package2/scripts')
		},
		{
			from: jetpack.path('../myvite/dist'),
			to: jetpack.path(buildOutput, 'client_packages/package2/ui')
		},
	);
